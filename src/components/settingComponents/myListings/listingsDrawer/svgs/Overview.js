...
const Overview = ({ fill }) => {
  return (
    ...
    >
      <g id="vuesax_bold_element-4-2" data-name="vuesax/bold/element-4">
        <g id="element-4">
          <path
            id="Vector"
          ...
          <path
            id="Vector-4"
            data-name="Vector"
            d="M8.5,4.9V2.1C8.5.6,7.86,0,6.27,0H2.23C.64,0,0,.6,0,2.1V4.9C0,6.4.64,7,2.23,7H6.27C7.86,7,8.5,6.4,8.5,4.9Z"
